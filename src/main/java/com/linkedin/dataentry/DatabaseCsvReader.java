...
public class DatabaseCsvReader {
	private final String[] FILE_ARRAY = new String[]{"database_files/Connection.csv","database_files/User.csv" , "database_files/Post.csv" ,"database_files/Comment.csv" ,"database_files/Like.csv" ,"database_files/ConnectionRequest.csv"};
