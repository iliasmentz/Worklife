...
public class ConnectionsController {
  ...
  @ApiOperation(value = "Return Connection Status with  Another User", notes = "0->Connected, 1->Not Connected , 2->UserId has sent Logged User a ConnectionRequest, 3-> Logged User has sent UserId a ConnectionRequest , 4->userId ==loggedUserId",
      response = ConnectionStatusDto.class)
  @ApiImplicitParams({
      @ApiImplicitParam(name = "userId", value = "user's id", required = true, dataType = "Long", example = "1")
  })
